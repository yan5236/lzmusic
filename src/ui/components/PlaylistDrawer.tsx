...
export default function PlaylistDrawer({ playerState, togglePlaylist, playSong, removeFromQueue }: PlaylistDrawerProps) {
  return (
    <div className={`fixed top-12 right-0 bottom-24 w-80 bg-white border-l border-slate-200 transform transition-transform duration-300 z-[60] shadow-2xl ${playerState.showPlaylist ? 'translate-x-0' : 'translate-x-full'}`}>
      {/* 头部 */}
